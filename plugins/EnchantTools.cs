    ...
    class EnchantTools : RustPlugin
    {
        ...
        void OnDispenserGather(ResourceDispenser dispenser, BaseEntity entity, Item item)
        {
            ...
            if (EnchantedTools.Contains(player.GetActiveItem().GetHashCode()))
            {
                ...
                {
                    case "sulfur.ore":
                        ReplaceContentsByName("sulfur", ref item);
                        break;
                    case "hq.metal.ore":
						Puts("-----1-----");
                        ReplaceContentsByName("metal.refined", ref item);
                        break;
                    case "metal.ore":
                        ReplaceContentsByName("metal.fragments", ref item);
                        break;
                    case "wolfmeat.raw":
                        ReplaceContentsByName("wolfmeat.cooked", ref item);
                        break;
                    case "meat.boar":
                        ReplaceContentsByName("meat.pork.cooked", ref item);
                        break;
                    case "fish.raw":
                        ReplaceContentsByName("fish.cooked", ref item);
                        break;
                    case "chicken.raw":
                        ReplaceContentsByName("chicken.cooked", ref item);
                        break;
                    case "bearmeat":
                        ReplaceContentsByName("bearmeat.cooked", ref item);
                        break;
					case "horsemeat.raw":
                        ReplaceContentsByName("horsemeat.cooked", ref item);
                        break;
					case "deermeat.raw":
                        ReplaceContentsByName("deermeat.cooked", ref item);
                        break;
                    case "wood":
                        ReplaceContentsByName("charcoal", ref item);
                        break;
                }
            }
        }
		...
		//Wasdik Start
		private void ReplaceContentsByName(string ItemName, ref Item item)
        {
            Item _item = ItemManager.CreateByName(ItemName, item.amount);
            item.info = _item.info;
            item.contents = _item.contents;
        }
		//Wasdik End
